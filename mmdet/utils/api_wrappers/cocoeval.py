...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[14] = _summarize(0, iouThr=.5, areaRng='small', maxDets=self.params.maxDets[2])
            stats[15] = _summarize(0, iouThr=.5, areaRng='medium', maxDets=self.params.maxDets[2])
...
class Params:
    ...
    def setDetParams(self):
        ...
        # self.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 20 ** 2], [20 ** 2, 100 ** 2], [100 ** 2, 1e5 ** 2]]
